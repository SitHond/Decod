...
function decodeSecret(answer) {
    if (answer === "Черный Клевер") {
        alert("Поздравляем! Введите в ЛС автора ответ на главный вопрос: Я начинаюсь как «Маленький Принц» в мире кода,
Продолжаюсь парадоксом,что меняет суда.
Ломаю я ящики,летаю в ночи,
И в одиночку хату купить обещаю в ночи.");
        return true;
    } else {
